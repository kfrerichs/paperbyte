  ...
  <div class="checkContainer">
    <form method="post" action="{{url('/play')}}" id="pointForm">
      ...
      <div>
        <div class="checkContainer">
          <div>
            <label class="checkLabel" for="hp">Trefferpunkte:</label>
            <input type="hidden" name="max_hp" id="max_hp" value="{{$character->max_hp}}">
            <input class="inputWidth" type="number" name="hp" id="hp" value="{{old('hp')?old('hp'):$character->hp}}">
          </div>
          <div>
            <label class="checkLabel" for="mp">Magiepunkte:</label>
            <input type="hidden" name="max_mp" id="max_mp" value="{{$character->max_mp}}">
            <input class="inputWidth" type="number" name="mp" id="mp" value="{{old('mp')?old('mp'):$character->mp}}"></br>
          </div>
        </div>
        <div class="fixFlex">
          <a class="btn btn-primary save" onClick="savePoints()">Änderung speichern</a>
          <a class="btn btn-primary regenerate" onClick="regenerate()">TP und MP Regenerieren</a>
        </div>
      </div>
