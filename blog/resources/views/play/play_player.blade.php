    ...
    @csrf
      <div class="points">
        <div class="pointsMargin">
          ...
          <input class="inputWidth woMargin" type="number" name="hp" id="hp" value="{{old('hp')?old('hp'):$character->hp}}">
        </div>
        <div class="pointsMargin">
          <label class="checkLabel woMargin" for="mp">Magiepunkte:</label>
          <input type="hidden" name="max_mp" id="max_mp" value="{{$character->max_mp}}">
          <input class="inputWidth woMargin" type="number" name="mp" id="mp" value="{{old('mp')?old('mp'):$character->mp}}"></br>
        </div>
