...
class ProtocolController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/protocol')->with('success', 'Eintrag erstellt');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $protocol->save();
        return redirect('/protocol')->with('success', 'Eintrag geändert');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('/protocol')->with('success', 'Eintrag gelöscht');
    }
}
